...
def car_pos_deter(contours):
    ...
    if len(contours) == 0:
        ...
        for i in range(0, len(contours)):
            ...
            if cntarea > 100 and cntarea < 500: #500-820
        ...
        while index < len(contours):
            ...
            if cntarea > 50 and cntarea < 90:
                ...
                if extent >= 0.6 and cv2.pointPolygonTest(car_cnt, (mark1_x, mark1_y), False) == 1:
            ...
            # car mark1 contour 20~50
                ...
                if extent >= 0.6 and cv2.pointPolygonTest(car_cnt, (mark2_x, mark2_y), False) == 1:
...
def car_angle_deter(car_center, mark1_center, mark2_center):########problem
    ...
    if angle1_in_degree <=0 and angle2_in_degree >=0:
        turnAngle = 180 + (angle1_in_degree + angle2_in_degree)*0.5 - default_direction

    else:
        turnAngle = (angle1_in_degree + angle2_in_degree)*0.5 - default_direction
